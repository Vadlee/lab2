 ...
 * Revision (2018): Christos Sakalis <christos.sakalis@it.uu.se>
 */
...
asm_atomic_inc_int32(volatile int32_t *var)
{
    __asm__ ("lock incl %0;"
	     : "+m" (*var));
}
 ...
 */
static inline void __attribute__((always_inline))
asm_inc_int32(volatile int32_t *var)
{
    __asm__ ("incl %0;"
	     : "+m" (*var));
}
 ...
 */
static inline void __attribute__((always_inline))
asm_atomic_dec_int32(volatile int32_t *var)
{
    __asm__ ("lock decl %0;"
	     : "+m" (*var));
}
 ...
 */
static inline void __attribute__((always_inline))
asm_dec_int32(volatile int32_t *var)
{
    __asm__ ("decl %0;"
	     : "+m" (*var));
}
...
asm_atomic_cmpxchg_int32(volatile int32_t *var, int32_t old, int32_t new) {
    int32_t ret;
 ...
 */
static inline int32_t __attribute__((always_inline))
asm_cmpxchg_int32(volatile int32_t *var, int32_t old, int32_t new)
{
    int32_t ret;
    /* cmpxchg uses eax as an implicit operand */
